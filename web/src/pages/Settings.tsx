    ...
    <div className="min-h-screen bg-[#F7F9FC] pb-6">
      ...
      <div className="max-w-[800px] mx-auto px-4 space-y-6">
        ...
        >
          ...
          {panel === "phone" ? (
            <>
              <h2 className="text-lg font-semibold text-slate-900 mb-4">绑定手机号</h2>
          ...
          {panel === "notifications" ? (
            <>
              <h2 className="text-lg font-semibold text-slate-900 mb-4">消息通知</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 rounded-xl border border-slate-200">
                  ...
                  <Switch checked={autoCleanUnreadEmails} onChange={setAutoCleanUnreadEmails} />
                </div>
          ...
          {panel === "security" ? (
            <>
              <h2 className="text-lg font-semibold text-slate-900 mb-4">账号安全</h2>
